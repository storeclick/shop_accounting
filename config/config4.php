...
define('INCLUDES_PATH', BASE_PATH . '/includes');     // مسیر فایل‌های شامل
...
define('SITE_AUTHOR', 'storeclick');                 // نویسنده
...
define('UPDATE_REPOSITORY', 'storeclick/shop_accounting'); // مخزن گیت‌هاب
